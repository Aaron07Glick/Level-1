...
public class Jeopardy implements ActionListener {
	...
	// 7. Add the firstButton to the quizPanel
		...
		thirdButton = createButton("button");
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (firstButton==buttonPressed) {
			askQuestion("when did the year of 1812 start", "1812", buttonCount);
			//playJeopardyTheme();
		}
		...
		// Or if the buttonPressed was the secondButton
			...
			askQuestion("If it took eight men ten hours to build a wall, how long would it take four men to build it?", "No time", buttonCount);
			//playJeopardyTheme();
		}

			// Call the askQuestion() method with a harder question
		else if (buttonPressed == thirdButton) {
			askQuestion("what happens twice in a moment, once in a minute, but never in a million years", "the letter m", buttonCount);
		}
